...
export const Sample = () => {
    ...
    return(
        <div style={{width:{xs:100,sm:200, md:300,lg:400,xl:500}, margin:100}} >
            ...
            <Grid container spacing={3} className="form" align="center">
                ...
                <Grid item xs={12}>
                    <TextField {...formik.getFieldProps('channel')} variant="outlined" placeholder="channel" name="channel"   fullWidth/>
